...
class ${upperTableName} extends PureComponent {
  constructor(props) {
    super(props);
    ...
    this.props.dispatchAction({
      type:'${lowerTableName}/setNewColumnsAction',
  ...
  onSelectColumns = () => {
    ...
    this.props.dispatchAction({
      type:'${lowerTableName}/setTransferModalAction',
      payload:false,
    });

    this.props.dispatchAction({
      type:'${lowerTableName}/setNewColumns',
  ...
  fetchDataSource = (requestData) => {
    this.props.dispatchAction({
      type:'${lowerTableName}/setTableLoadingAction',
      payload:true,
    });
    ...
    this.props.dispatchAction({
      type:'${lowerTableName}/fetchTableDataAction',
      payload:{
        url:this.url,
        params,
  ...
  hideModal = () => {
    this.props.dispatchAction({
      type:'${lowerTableName}/setTransferModal',
      payload:false,
    })
  };
...
export default connect(({ ${lowerTableName} }) => ({
  modalVisible: ${lowerTableName}.modalVisible,
  loading:${lowerTableName}.loading,
  data:${lowerTableName}.data,
  tableModalVisible:${lowerTableName}.tableModalVisible,
  newColumns:${lowerTableName}.newColumns,
  pagination:${lowerTableName}.pagination,
}),mapDispatchToProps,mergeProps,{ withRef: true })(${upperTableName});
